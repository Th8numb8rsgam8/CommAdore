...
class AFSIMCommEvents:
   MESSAGE_OUTGOING = "MESSAGE_OUTGOING"
   MESSAGE_INCOMING = "MESSAGE_INCOMING"
   MESSAGE_INTERNAL = "MESSAGE_INTERNAL"
   MESSAGE_DELIVERY_ATTEMPT = "MESSAGE_DELIVERY_ATTEMPT"
   MESSAGE_DISCARDED = "MESSAGE_DISCARDED"
   MESSAGE_FAILED_ROUTING = "MESSAGE_FAILED_ROUTING"
   MESSAGE_HOP = "MESSAGE_HOP"
   MESSAGE_UPDATED = "MESSAGE_UPDATED"
   MESSAGE_QUEUED = "MESSAGE_QUEUED"
   MESSAGE_RECEIVED = "MESSAGE_RECEIVED"
   MESSAGE_TRANSMITTED = "MESSAGE_TRANSMITTED"
   MESSAGE_TRANSMITTED_HEARTBEAT = "MESSAGE_TRANSMITTED_HEARTBEAT"
   MESSAGE_TRANSMIT_ENDED = "MESSAGE_TRANSMIT_ENDED"
